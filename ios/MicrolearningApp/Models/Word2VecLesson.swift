    ...
    static let word2vec = LearningLesson(
        ...
        cards: [
            ...
            .illustrated(
                ...
                paragraphs: [
                    [.plain("Word2Vec puts every word on a map. Not a real map, an imaginary one. A word\u{2019}s spot is just a list of a few hundred numbers, and that list has a name: its "),
                     .term("word vector"),
                     .plain(" (researchers also call it an "),
                     .term("embedding"),
                     .plain(").")],
