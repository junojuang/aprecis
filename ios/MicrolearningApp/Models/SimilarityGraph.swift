...
enum SimilarityGraph {
    ...
    private static let allPapers: [PaperMeta] = [
        ...
        PaperMeta(id: "vit",
                  cluster: .vision,
                  concepts: ["vision transformer", "transformer", "attention", "image",
                             "patch", "position embedding", "pretraining", "scaling"],
                  influence: 0.96, trending: 0.86),
        PaperMeta(id: "ddpm",
                  cluster: .generative,
                  concepts: ["diffusion", "denoising", "image generation",
                             "noise schedule", "sampling", "generative", "vision"],
                  influence: 0.96, trending: 0.88),
        PaperMeta(id: "clip",
                  cluster: .vision,
                  concepts: ["image", "language", "contrastive learning", "embedding",
                             "zero shot", "natural language supervision", "multimodal"],
                  influence: 1.00, trending: 0.92),
        PaperMeta(id: "stable-diffusion",
                  cluster: .generative,
                  concepts: ["diffusion", "latent", "image generation", "text conditioning",
                             "autoencoder", "multimodal", "open weights"],
                  influence: 1.00, trending: 0.94),
        PaperMeta(id: "controlnet",
                  cluster: .generative,
                  concepts: ["diffusion", "control", "conditioning", "pose", "edge map",
                             "image generation", "latent", "structure"],
                  influence: 0.92, trending: 0.90),
        PaperMeta(id: "sam",
                  cluster: .vision,
                  concepts: ["segmentation", "mask", "promptable", "vision transformer",
                             "image", "annotation", "foundation model"],
                  influence: 0.98, trending: 0.92),
        PaperMeta(id: "t5",
                  cluster: .language,
                  concepts: ["transformer", "encoder decoder", "text to text",
                             "transfer learning", "pretraining", "span corruption", "language"],
                  influence: 0.92, trending: 0.78),
        PaperMeta(id: "chinchilla",
                  cluster: .language,
                  concepts: ["language model", "scaling law", "compute optimal",
                             "parameters", "tokens", "training data", "undertraining"],
                  influence: 0.94, trending: 0.88),
        PaperMeta(id: "palm",
                  cluster: .language,
                  concepts: ["language model", "scaling", "emergent ability",
                             "parameters", "multilingual", "reasoning", "compute"],
                  influence: 0.96, trending: 0.86),
        PaperMeta(id: "llama",
                  cluster: .language,
                  concepts: ["language model", "open weights", "scaling law",
                             "tokens", "fine tuning", "foundation model", "local model"],
                  influence: 1.00, trending: 0.96),
        PaperMeta(id: "mixtral",
                  cluster: .language,
                  concepts: ["language model", "mixture of experts", "sparse",
                             "router", "active parameters", "open weights", "inference"],
                  influence: 0.92, trending: 0.90),
        PaperMeta(id: "reflexion",
                  cluster: .reasoning,
                  concepts: ["agent", "reflection", "verbal memory", "reinforcement learning",
                             "tool use", "feedback", "language model"],
                  influence: 0.86, trending: 0.84),
        PaperMeta(id: "flashattention",
                  cluster: .language,
