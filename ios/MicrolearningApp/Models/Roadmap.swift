...
enum Roadmap {
    ...
    static let trunk: [Node] = [
        Node(id: "perceptron", title: "Perceptron", slug: "perceptron", year: 1958,
             oneLiner: "One neuron that teaches itself by its own mistakes."),
        Node(id: "backprop",   title: "Backprop",   slug: "backprop",   year: 1986,
             oneLiner: "How a network with a middle layer can learn anything."),
        Node(id: "lenet",      title: "LeNet",      slug: "lenet",      year: 1998,
             oneLiner: "The first network that could really see."),
        Node(id: "alexnet",    title: "AlexNet",    slug: "alexnet",    year: 2012,
             oneLiner: "Deep learning wins the world by a mile."),
        Node(id: "word2vec",   title: "Word2Vec",   slug: "word2vec",   year: 2013,
             oneLiner: "Words become places on a map."),
        Node(id: "gans",       title: "GANs",       slug: "gans",       year: 2014,
             oneLiner: "Two networks in a duel that teaches both."),
        Node(id: "seq2seq",    title: "Seq2Seq",    slug: "seq2seq",    year: 2014,
             oneLiner: "One sentence in, a different sentence out."),
        Node(id: "resnet",     title: "ResNet",     slug: "resnet",     year: 2015,
             oneLiner: "Let the signal skip ahead. Depth solved."),
        Node(id: "attention",  title: "Attention",  slug: "attention",  year: 2017,
             oneLiner: "Every word reads every other word. The Transformer."),
        Node(id: "bert",       title: "BERT",       slug: "bert",       year: 2018,
             oneLiner: "Read both sides at once."),
        Node(id: "gpt3",       title: "GPT-3",      slug: "gpt3",       year: 2020,
             oneLiner: "A model so large that examples replace training."),
        Node(id: "instructgpt", title: "InstructGPT", slug: "instructgpt", year: 2022,
             oneLiner: "Human feedback teaches it to follow what you ask."),
        Node(id: "deepseek-r1", title: "DeepSeek-R1", slug: "deepseek-r1", year: 2025,
    ...
    static let visionBranch = Branch(
        ...
        accentHex: "7b4ba4",
        nodes: [
            Node(id: "vit",       title: "ViT",              slug: "vit",        year: 2020,
                 oneLiner: "Apply the Transformer to images. Conv nets get a rival."),
            Node(id: "ddpm",      title: "DDPM",             slug: "ddpm",       year: 2020,
                 oneLiner: "Generate images by gradually denoising noise."),
            Node(id: "clip",      title: "CLIP",             slug: "clip",       year: 2021,
                 oneLiner: "One model that knows what images and captions share."),
            Node(id: "stable-diffusion",        title: "Stable Diffusion", slug: "sd",         year: 2022,
                 oneLiner: "Diffusion at scale, on consumer hardware, open weights."),
            Node(id: "controlnet",title: "ControlNet",       slug: "controlnet", year: 2023,
                 oneLiner: "Pose, sketch, depth: steer the diffusion model on demand."),
            Node(id: "sam",       title: "Segment Anything", slug: "sam",        year: 2023,
    ...
    static let reasoningBranch = Branch(
        ...
        accentHex: "c07014",
        nodes: [
            Node(id: "chain-of-thought",         title: "Chain-of-Thought", slug: "cot",        year: 2022,
                 oneLiner: "Add 'let's think step by step' and accuracy jumps."),
            Node(id: "self-consistency", title: "Self-Consistency", slug: "selfconsist", year: 2022,
                 oneLiner: "Sample many reasoning paths, take the majority vote."),
            Node(id: "react",       title: "ReAct",            slug: "react",      year: 2022,
                 oneLiner: "Interleave thinking and acting in a tight loop."),
            Node(id: "toolformer",  title: "Toolformer",       slug: "toolformer", year: 2023,
                 oneLiner: "Models that decide for themselves when to call a tool."),
            Node(id: "tree-of-thoughts",         title: "Tree of Thoughts", slug: "tot",        year: 2023,
                 oneLiner: "Branch on every reasoning step. Search the tree."),
            Node(id: "reflexion",   title: "Reflexion",        slug: "reflexion",  year: 2023,
